              ...
              <div className="col-md-6">
                <div className="product-card style-two h-100 p-8 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2 flex-align gap-16">
                  <div className="">
                    ...
                    >
                      <img src="src/assets/images/thumbs/best-sell1.png" alt="" />
                    </Link>
                ...
                <div className="product-card style-two h-100 p-8 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2 flex-align gap-16">
                  <div className="">
                    ...
                    <Link
                      ...
                      className="product-card__thumb flex-center"
                    >
                      <img src="src/assets/images/thumbs/best-sell2.png" alt="" />
                    </Link>
                ...
                <div className="product-card style-two h-100 p-8 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2 flex-align gap-16">
                  <div className="">
                    ...
                    <Link
                      ...
                      className="product-card__thumb flex-center"
                    >
                      <img src="src/assets/images/thumbs/best-sell3.png" alt="" />
                    </Link>
                ...
                <div className="product-card style-two h-100 p-8 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2 flex-align gap-16">
                  <div className="">
                    ...
                    <Link
                      ...
                      className="product-card__thumb flex-center"
                    >
                      <img src="src/assets/images/thumbs/best-sell4.png" alt="" />
                    </Link>
