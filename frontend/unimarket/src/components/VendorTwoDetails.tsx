              ...
              <div className="blog-sidebar border border-gray-100 rounded-8 p-32 mb-40">
                ...
                <div className="d-flex flex-column gap-24">
                  <div className="d-flex align-items-center flex-sm-nowrap flex-wrap gap-16">
                    ...
                    >
                      <img
                        src="src/assets/images/thumbs/best-selling-img1.png"
                        alt=""
                        className=""
                      />
                    </Link>
                  ...
                  <div className="d-flex align-items-center flex-sm-nowrap flex-wrap gap-16">
                    ...
                    >
                      <img
                        src="src/assets/images/thumbs/best-selling-img2.png"
                        alt=""
                        className=""
                      />
                    </Link>
                  ...
                  <div className="d-flex align-items-center flex-sm-nowrap flex-wrap gap-16">
                    ...
                    >
                      <img
                        src="src/assets/images/thumbs/best-selling-img3.png"
                        alt=""
                        className=""
                      />
                    </Link>
                  ...
                  <div className="d-flex align-items-center flex-sm-nowrap flex-wrap gap-16">
                    ...
                    >
                      <img
                        src="src/assets/images/thumbs/best-selling-img4.png"
                        alt=""
                        className=""
                      />
                    </Link>
                  ...
                  <div className="d-flex align-items-center flex-sm-nowrap flex-wrap gap-16">
                    ...
                    >
                      <img
                        src="src/assets/images/thumbs/best-selling-img5.png"
                        alt=""
                        className=""
                      />
                    </Link>
                  ...
                  <div className="d-flex align-items-center flex-sm-nowrap flex-wrap gap-16">
                    ...
                    >
                      <img
                        src="src/assets/images/thumbs/best-selling-img6.png"
                        alt=""
                        className=""
                      />
                    </Link>
            ...
            >
              ...
              <div className="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                <div className="product-card__thumb rounded-8 bg-gray-50 position-relative">
                  ...
                  >
                    <img
                      src="src/assets/images/thumbs/trending-three-img4.png"
                      alt=""
                      className="w-auto max-w-unset"
                    />
                  </Link>
