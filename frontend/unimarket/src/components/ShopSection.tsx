          ...
          <div className="col-lg-9">
            ...
            <div className={`list-grid-wrapper ${grid && "list-view"}`}>
              ...
              <div className="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                ...
                >
                  <img
                    src="src/assets/images/thumbs/product-two-img11.png"
                    alt=""
                    className="w-auto max-w-unset"
                  />
                </Link>
              ...
              <div className="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                ...
                >
                  ...
                  <img
                    src="src/assets/images/thumbs/product-two-img12.png"
                    alt=""
                    className="w-auto max-w-unset"
                  />
                </Link>
              ...
              <div className="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                ...
                >
                  <img
                    src="src/assets/images/thumbs/product-two-img13.png"
                    alt=""
                    className="w-auto max-w-unset"
                  />
                </Link>
              ...
              <div className="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                ...
                >
                  <img
                    src="src/assets/images/thumbs/product-two-img14.png"
                    alt=""
                    className="w-auto max-w-unset"
                  />
                </Link>
              ...
              <div className="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                ...
                >
                  ...
                  <img
                    src="src/assets/images/thumbs/product-two-img15.png"
                    alt=""
                    className="w-auto max-w-unset"
                  />
                </Link>
