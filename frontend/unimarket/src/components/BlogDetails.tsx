          ...
          <div className="col-lg-8 pe-xl-4">
            ...
            <div className="mt-48">
              <div className="row gy-4">
                <div className="col-sm-6 col-xs-6">
                  <img
                    src="src/assets/images/thumbs/blog-details-img1.png"
                    alt=""
                ...
                <div className="col-sm-6 col-xs-6">
                  <img
                    src="src/assets/images/thumbs/blog-details-img2.png"
                    alt=""
                    className="rounded-16"
                  />
                </div>
            ...
            <div className="my-48">
              <form action="#">
                ...
                <div className="d-flex align-items-start gap-16 mb-32 pb-32 border-bottom border-gray-100">
                  <img
                    src="src/assets/images/thumbs/comment-img2.png"
                    alt=""
                    className="w-40 h-40 rounded-circle object-fit-cover flex-shrink-0"
                  />
                  <div className="flex-grow-1">
                ...
                <div className="d-flex align-items-start gap-16 mb-32 pb-32 border-bottom border-gray-100">
                  <img
                    src="src/assets/images/thumbs/comment-img3.png"
                    alt=""
                    className="w-40 h-40 rounded-circle object-fit-cover flex-shrink-0"
                  />
                  <div className="flex-grow-1">
                ...
                <div className="d-flex align-items-start gap-16 mb-32 pb-32 border-bottom border-gray-100">
                  <img
                    src="src/assets/images/thumbs/comment-img4.png"
                    alt=""
                    className="w-40 h-40 rounded-circle object-fit-cover flex-shrink-0"
                  />
                  <div className="flex-grow-1">
                ...
                <div className="d-flex align-items-start gap-16">
                  <img
                    src="src/assets/images/thumbs/comment-img5.png"
                    alt=""
                    className="w-40 h-40 rounded-circle object-fit-cover flex-shrink-0"
                  />
                  <div className="flex-grow-1">
