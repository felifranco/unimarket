      ...
      <div className="container container-lg">
        <div className="border border-gray-100 p-24 rounded-16">
          ...
          <div className="top-brand__slider">
            <Slider {...settings}>
              <div>
                <img src="src/assets/images/thumbs/brand-three-img1.png" alt="" />
              </div>
              <div>
                <img src="src/assets/images/thumbs/brand-three-img2.png" alt="" />
              </div>
              <div>
                <img src="src/assets/images/thumbs/brand-three-img3.png" alt="" />
              </div>
              <div>
                <img src="src/assets/images/thumbs/brand-three-img4.png" alt="" />
              </div>
              <div>
                <img src="src/assets/images/thumbs/brand-three-img5.png" alt="" />
              </div>
              <div>
                <img src="src/assets/images/thumbs/brand-three-img6.png" alt="" />
              </div>
              <div>
                <img src="src/assets/images/thumbs/brand-three-img7.png" alt="" />
              </div>
              <div>
                <img src="src/assets/images/thumbs/brand-three-img8.png" alt="" />
              </div>
              <div>
                <img src="src/assets/images/thumbs/brand-three-img5.png" alt="" />
              </div>
